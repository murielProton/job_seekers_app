 ...
 */
final class Version20200720155516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, for_name VARCHAR(10) DEFAULT NULL, sir_name VARCHAR(10) DEFAULT NULL, telephone INT DEFAULT NULL, e_mail VARCHAR(20) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mouvie_list_mouvies (mouvie_list_id INT NOT NULL, mouvies_id INT NOT NULL, INDEX IDX_59ED8D587EA32444 (mouvie_list_id), INDEX IDX_59ED8D58B1E266D9 (mouvies_id), PRIMARY KEY(mouvie_list_id, mouvies_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE mouvies_genre (mouvies_id INT NOT NULL, genre_id INT NOT NULL, INDEX IDX_65AE29E4B1E266D9 (mouvies_id), INDEX IDX_65AE29E44296D31F (genre_id), PRIMARY KEY(mouvies_id, genre_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
