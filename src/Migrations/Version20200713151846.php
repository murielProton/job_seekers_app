 ...
 */
final class Version20200713151846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, web_site_name VARCHAR(20) DEFAULT NULL, company_name VARCHAR(20) NOT NULL, job_advertisement LONGTEXT DEFAULT NULL, contact LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', posting_date DATE NOT NULL, folow_up_date DATE NOT NULL, answer LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', unsolicited TINYINT(1) DEFAULT NULL, comments LONGTEXT NOT NULL, job_interview LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
